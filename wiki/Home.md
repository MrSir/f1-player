...
## Summary
Formula 1 Player (F1P) is a tool for watching F1 races from a data perspective.
...
For more details on the installation, features, etc. see the other WIKI pages in the sidebar.