...
def test_initialization(mock_camera: MagicMock) -> None:
    ...
    assert hasattr(controller, "zoom_camera")
...
@pytest.mark.parametrize(
    ("initial_zoom", "expected_zoom", "expected_calls_to_zoom", "case"),
    [
...
def test_zoom_camera_in(
    initial_zoom: int,
    expected_zoom: int,
    expected_calls_to_zoom: int,
    case: str,
    camera_controller: CameraController,
    mocker: MockerFixture,
) -> None:
    mock_zoom_camera = mocker.patch.object(camera_controller, "zoom_camera")
